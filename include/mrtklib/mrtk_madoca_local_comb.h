 ...
 */
void grid_intp_trop(const gtime_t gt, const stat_t* stat, lclblock_t* lclblk);
 ...
 */
void sta_sel_trop(const gtime_t time, const stat_t* stat, lclblock_t* lslblk);
 ...
 */
void grid_intp_iono(const gtime_t gt, const stat_t* stat, lclblock_t* lclblk, double maxres, int* nrej, int* ncnt);
 ...
 * @param[in,out] lslblk Local block information struct
 */
void sta_sel_iono(const gtime_t gt, const stat_t* stat, lclblock_t* lslblk);
