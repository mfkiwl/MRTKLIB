...
static const double chisqr[100] = {
    ...
    74.7,76.0,77.3,78.6,80.0,81.4,82.7,84.0,85.4,86.7,
...
static int resamb_LAMBDA(rtk_t *rtk, double *bias, double *xa)
{
    ...
    trace(NULL,4,"N(0)="); tracemat(NULL,4,y+na,1,nb,10,3);
    ...
    for (i=0;i<MAXSAT;i++) {
        for (k=1;k<nf;k++) {
            ...
            if ((inno[1]>0.0)&&(vvf_*vvf_>inno[1]*inno[1]*sig2)) {
                ...
                trace(NULL,2,"Residuals validation:freq outlier detected (stage=%1d sat=%2d f=%d %d v=%6.3f sig=%.3f)\n",
...
static int filter2(rtk_t *rtk, double *x, double *P, double *Q, const double *H,
