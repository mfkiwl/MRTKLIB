...
/**
 * @file mrtk_bits.c
 * @brief MRTKLIB Bits Module — Implementation.
 *
...
/* get unsigned bits -----------------------------------------------------------
 * get unsigned/signed bits from byte data
...
extern int decode_word(uint32_t word, uint8_t* data) {
    const uint32_t hamming[] = {0xBB1F3480, 0x5D8F9A40, 0xAEC7CD00, 0x5763E680, 0x6BB1F340, 0x8B7A89C0};
    uint32_t parity = 0, w;
    int i;
